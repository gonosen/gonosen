...
interns = Intern.create([
 {  title: 'SunBridge Global Ventures Inc.',
    ...
    starting_time: Time.mktime(2016, 12, 24, 00, 00, 00),
    ending_time: Time.mktime(2016, 12, 25, 00, 00, 00),
    location: "大阪府豊中市蛍池",
    owner: "大阪大学rails有志の会",
 ...
 {  title: 'ヒューマンアカデミービジネススクール (MBA Programme at HABS)' ,
    ...
    starting_time: Time.mktime(2016, 12, 14, 00, 00, 00),
    ending_time: Time.mktime(2016, 12, 15, 00, 00, 00),
